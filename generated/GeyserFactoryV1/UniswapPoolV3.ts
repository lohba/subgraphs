...
export class UniswapPoolV3__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapPoolV3__collectResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapPoolV3__collectProtocolResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapPoolV3__mintResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapPoolV3__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class UniswapPoolV3__observeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class UniswapPoolV3__positionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class UniswapPoolV3__protocolFeesResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapPoolV3__slot0Result {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class UniswapPoolV3__snapshotCumulativesInsideResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniswapPoolV3__swapResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapPoolV3__ticksResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class UniswapPoolV3 extends ethereum.SmartContract {
  static bind(address: Address): UniswapPoolV3 {
    return new UniswapPoolV3("UniswapPoolV3", address);
  }
  ...
  burn(
    ...
    return new UniswapPoolV3__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_burn(
    ...
    tickUpper: i32,
    amount: BigInt
  ): ethereum.CallResult<UniswapPoolV3__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  collect(
    ...
    return new UniswapPoolV3__collectResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collect(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<UniswapPoolV3__collectResult> {
    let result = super.tryCall(
      "collect",
      "collect(address,int24,int24,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__collectResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): UniswapPoolV3__collectProtocolResult {
    let result = super.call(
      "collectProtocol",
    ...
    return new UniswapPoolV3__collectProtocolResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<UniswapPoolV3__collectProtocolResult> {
    let result = super.tryCall(
      "collectProtocol",
      "collectProtocol(address,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__collectProtocolResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  mint(
    ...
    return new UniswapPoolV3__mintResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_mint(
    ...
    amount: BigInt,
    data: Bytes
  ): ethereum.CallResult<UniswapPoolV3__mintResult> {
    let result = super.tryCall(
      "mint",
      "mint(address,int24,int24,uint128,bytes):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__mintResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  observations(param0: BigInt): UniswapPoolV3__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new UniswapPoolV3__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_observations(
    param0: BigInt
  ): ethereum.CallResult<UniswapPoolV3__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,int56,uint160,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  observe(secondsAgos: Array<BigInt>): UniswapPoolV3__observeResult {
    let result = super.call(
      "observe",
    ...
    return new UniswapPoolV3__observeResult(
  ...
  try_observe(
  ...
  ): ethereum.CallResult<UniswapPoolV3__observeResult> {
    let result = super.tryCall(
      "observe",
      "observe(uint32[]):(int56[],uint160[])",
      [ethereum.Value.fromUnsignedBigIntArray(secondsAgos)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__observeResult(
  ...
  positions(param0: Bytes): UniswapPoolV3__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new UniswapPoolV3__positionsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_positions(
    param0: Bytes
  ): ethereum.CallResult<UniswapPoolV3__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(bytes32):(uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__positionsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  protocolFees(): UniswapPoolV3__protocolFeesResult {
    let result = super.call(
      "protocolFees",
    ...
    return new UniswapPoolV3__protocolFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_protocolFees(): ethereum.CallResult<UniswapPoolV3__protocolFeesResult> {
    let result = super.tryCall(
      "protocolFees",
      "protocolFees():(uint128,uint128)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__protocolFeesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  slot0(): UniswapPoolV3__slot0Result {
    let result = super.call(
      "slot0",
    ...
    return new UniswapPoolV3__slot0Result(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_slot0(): ethereum.CallResult<UniswapPoolV3__slot0Result> {
    let result = super.tryCall(
      "slot0",
      "slot0():(uint160,int24,uint16,uint16,uint16,uint8,bool)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__slot0Result(
        value[0].toBigInt(),
        value[1].toI32(),
        value[2].toI32(),
        value[3].toI32(),
  ...
  snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): UniswapPoolV3__snapshotCumulativesInsideResult {
    let result = super.call(
      "snapshotCumulativesInside",
    ...
    return new UniswapPoolV3__snapshotCumulativesInsideResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): ethereum.CallResult<UniswapPoolV3__snapshotCumulativesInsideResult> {
    let result = super.tryCall(
      "snapshotCumulativesInside",
      "snapshotCumulativesInside(int24,int24):(int56,uint160,uint32)",
      [ethereum.Value.fromI32(tickLower), ethereum.Value.fromI32(tickUpper)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__snapshotCumulativesInsideResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  swap(
    ...
    return new UniswapPoolV3__swapResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swap(
    ...
    sqrtPriceLimitX96: BigInt,
    data: Bytes
  ): ethereum.CallResult<UniswapPoolV3__swapResult> {
    let result = super.tryCall(
      "swap",
      "swap(address,bool,int256,uint160,bytes):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__swapResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  ticks(param0: i32): UniswapPoolV3__ticksResult {
    let result = super.call(
      "ticks",
    ...
    return new UniswapPoolV3__ticksResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_ticks(param0: i32): ethereum.CallResult<UniswapPoolV3__ticksResult> {
    let result = super.tryCall(
      "ticks",
      "ticks(int24):(uint128,int128,uint256,uint256,int56,uint160,uint32,bool)",
      [ethereum.Value.fromI32(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPoolV3__ticksResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
