...
export class BalancerWeightedPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class BalancerWeightedPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class BalancerWeightedPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class BalancerWeightedPool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class BalancerWeightedPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class BalancerWeightedPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class BalancerWeightedPool extends ethereum.SmartContract {
  static bind(address: Address): BalancerWeightedPool {
    return new BalancerWeightedPool("BalancerWeightedPool", address);
  }
  ...
  getPausedState(): BalancerWeightedPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new BalancerWeightedPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getPausedState(): ethereum.CallResult<
    BalancerWeightedPool__getPausedStateResult
  > {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new BalancerWeightedPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  onExitPool(
    ...
    userData: Bytes
  ): BalancerWeightedPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new BalancerWeightedPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<BalancerWeightedPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerWeightedPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): BalancerWeightedPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new BalancerWeightedPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<BalancerWeightedPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerWeightedPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  onSwap(
    request: BalancerWeightedPool__onSwapInputRequestStruct,
  ...
  queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): BalancerWeightedPool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new BalancerWeightedPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<BalancerWeightedPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerWeightedPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray()
      )
    );
  ...
  queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): BalancerWeightedPool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new BalancerWeightedPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<BalancerWeightedPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BalancerWeightedPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray()
      )
    );
