...
export class UniswapFactoryV3__parametersResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: i32;
...
export class UniswapFactoryV3 extends ethereum.SmartContract {
  static bind(address: Address): UniswapFactoryV3 {
    return new UniswapFactoryV3("UniswapFactoryV3", address);
  }
  ...
  parameters(): UniswapFactoryV3__parametersResult {
    let result = super.call(
      "parameters",
    ...
    return new UniswapFactoryV3__parametersResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toI32(),
  ...
  try_parameters(): ethereum.CallResult<UniswapFactoryV3__parametersResult> {
    let result = super.tryCall(
      "parameters",
      "parameters():(address,address,address,uint24,int24)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new UniswapFactoryV3__parametersResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toI32(),
